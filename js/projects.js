...
const projects = [
  {
    ...
    page: {
      content: [
        { type: "text", html: `Joining <a href="http://chromosphere-la.com">Chromosphere</a> on this project for <a href="https://panic.com">Panic</a>, I was responsible for all the animation starting at 00:10 and compositing for the whole project. Video courtesy of <a href="https://www.youtube.com/@RetroDodo">Retro Dodo</a>.` },
        { type: "text", html: `Colour promotional version — 800×480 pixels` },
        { type: "bracket", label: "video: colour promotional version" },
        { type: "text", html: `Black &amp; white interactive version as seen on the Playdate — 400×240 pixels` },
        ...
        { type: "heading", text: "UI Animations." },
        { type: "text", html: `I also animated some UI animations and transitions within the Playdate's menu system and lock screen.` },
        { type: "bracket", label: "gif: present animation" },
        { type: "bracket", label: "gif: catalog animation" },
        { type: "bracket", label: "gif: outro animation" },
        { type: "bracket", label: "gif: lock screen animation" },
      ],
      links: [],
    },
  },

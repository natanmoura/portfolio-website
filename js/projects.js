  ...
  },
  {
    ...
    page: {
      content: [
        ...
        { type: "bracket", label: "video: character and prop animation sequence — not yet uploaded" },
  ...
  },
  {
    ...
    page: {
      content: [
        ...
        { type: "bracket", label: "video: trailer — not yet uploaded" },
        { type: "heading", text: "Behind the scenes." },
        ...
        { type: "bracket", label: "images: behind the scenes compositing process — not yet uploaded" },
      ],
      links: [],
    },
  },
  {
    ...
    page: {
      content: [
        ...
        { type: "mux", src: "https://player.mux.com/rT5mLXjAqdvocYw9fMrzHPFzeULEkVnv2a00PmaqrQN8?autoplay&muted" },
  ...
  },
  {
    ...
    page: {
      content: [
        ...
        { type: "bracket", label: "video: The Number 8 — not yet uploaded" },
        { type: "mux", src: "https://player.mux.com/8D8VT4deytB2tuVXaQoBQUVviMEAPtuo5YZG6T7CYd8?autoplay&muted" },
        { type: "caption", html: `Baby Teeth` },
        { type: "mux", src: "https://player.mux.com/02phDUfkw517NYdqbjvn8ACE2GpYcHvB1DRraFaBflIQ?autoplay&muted" },
        { type: "caption", html: `Sand` },
        { type: "mux", src: "https://player.mux.com/sIrReFG9IL9VEsmU02kMGGhQnSuL02PKXmbwB3W6AMttc?autoplay&muted" },
        { type: "caption", html: `The Internet` },
  ...
  },
  {
    ...
    page: {
      content: [
        ...
        { type: "mux", src: "https://player.mux.com/7002g2t8xx9XOzk1xCgjZHAdLWiQbd02Rywxa6s028Gr8o?autoplay&muted" },
        ...
        { type: "mux", src: "https://player.mux.com/wX4PiGnk9VsOF8hVedaCTRWGcGLP5DF26l7p3YNCPbE?autoplay&muted" },
      ],
      links: [],
    },
  },
  {
    ...
    page: {
      content: [
        ...
        { type: "mux", src: "https://player.mux.com/tfPcptKYgz4PNnAU31tpUWDEVFE00D3Ng2w4u1uS8DTU?autoplay&muted" },
        { type: "bracket", label: "gif: character animation 1 — not yet uploaded" },
        { type: "bracket", label: "gif: character animation 2 — not yet uploaded" },
        { type: "bracket", label: "gif: character animation 3 — not yet uploaded" },
        { type: "bracket", label: "gif: character animation 4 — not yet uploaded" },
        { type: "bracket", label: "gif: character animation 5 — not yet uploaded" },
        { type: "bracket", label: "gif: character animation 6 — not yet uploaded" },
      ],
      links: [],
    },
  },
  {
    ...
    page: {
      content: [
        ...
        { type: "mux", src: "https://player.mux.com/8Bi6AQe9cv02XdnW35B879ae7QVkNw1GqFZ7mWcpwZH00?autoplay&muted" },
      ],
      links: [],
    },
  },

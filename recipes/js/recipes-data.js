    ...
    components: [
      ...
      },
      {
        ...
        ingredients: [
          ...
          { q: 1, u: 'tsp', n: 'red pepper flakes', aisle: 'Spices & Dried Herbs', buyAs: 'chili flakes' },
    ...
    components: [
      {
        name: 'Chimichurri',
        ingredients: [
          { q: 0.75, u: 'cup', n: 'olive oil', aisle: 'Oils & Vinegars', buy: { q: 180, u: 'mL' } },
          { q: 3, u: 'tbsp', n: 'white wine vinegar', aisle: 'Oils & Vinegars', buy: { q: 45, u: 'mL' } },
          { q: 3, u: null, n: 'garlic cloves', aisle: 'Produce', buyAs: 'garlic', buy: { q: 0.3, u: 'head' } },
          { q: 2, u: 'tbsp', n: 'lemon zest', aisle: 'Produce', buyAs: 'lemons', buy: { q: 3, u: null }, buyNote: 'zest only — buy whole' },
          { q: 1.5, u: 'tsp', n: 'red pepper flakes', aisle: 'Spices & Dried Herbs', buyAs: 'chili flakes' },
          { q: 3, u: 'tbsp', n: 'fresh parsley', aisle: 'Produce', note: 'chopped', buy: { q: 0.25, u: 'bunch' } },
          { q: 3, u: 'tbsp', n: 'fresh oregano', aisle: 'Produce', note: 'chopped — or 1 tbsp dried', buy: { q: 0.25, u: 'bunch' } },
          { q: 3, u: 'tbsp', n: 'cilantro', aisle: 'Produce', note: 'chopped — more parsley works if you\'d rather skip it', buy: { q: 0.25, u: 'bunch' } },
          { q: 0.5, u: 'tsp', n: 'salt', aisle: 'Spices & Dried Herbs', note: 'sea salt', buy: { q: null, u: null } },
        ],
        steps: [
          'Whisk the olive oil, white wine vinegar, garlic, lemon zest and red pepper flakes together vigorously in a medium bowl until emulsified.',
          'Add the parsley, oregano, cilantro and salt, and whisk again.',

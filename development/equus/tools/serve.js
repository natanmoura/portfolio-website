...
// up .js and .glb types from the Windows registry and gets them wrong.
const http = require('http');
const fs = require('fs');
const path = require('path');

const PORT = Number(process.env.PORT || process.argv[2] || 5183);
...
http
  ...
  .listen(PORT, () => console.log(`Equus on http://localhost:${PORT}`));

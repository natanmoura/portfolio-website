...
const SYNONYMS = {
  ...
  roadEase: ['slope', 'steep', 'grade', 'climb', 'hill', 'bridge', 'smooth', 'ease', 'gradual'],
  roadColumnWidth: ['pier', 'support', 'column', 'thickness', 'leg', 'stilts'],
  roadBridging: ['bridge', 'viaduct', 'ravine', 'span', 'cliff', 'columns', 'piers'],
  maxBuildSlope: ['cliff', 'steep', 'slope', 'buildable', 'flat', 'terrain', 'mesa'],

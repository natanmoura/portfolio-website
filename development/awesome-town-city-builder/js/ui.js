...
export const CONTROL_DEFS = [
  ...
  },
  {
    ...
    items: [
      ...
      R('roadColumnWidth', 'Column thickness', 0.1, 3, 0.05, 'How thick each support is. One thickness for the whole town: a highway is held up by a pair, one under each edge of its deck, and a street by a single one down the middle of its path, so the count is what tells them apart rather than the girth.', { live: false, hard: [0.02, 20] }),
      {
        key: 'roadBridging',
